...
class MemberController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Member'])) {
            ...
            if (isset($_POST['Member']['group_id'])) {
                $group_id = $_POST['Member']['group_id'];
            }
            //echo  $model->id;
            //exit;
            ...
            if ($model->save()) {
                ...
                if (isset($_POST['Member']['group_id'])) {
                    if (count($group_id) > 0) {
                        MemberGroup::model()->deleteAllByAttributes(array('member_id' => $model->id));
    ...
    public function actionUpdate($id) {
        ...
        $model2 = MemberGroup::model()->findAllByAttributes(array('member_id' => $id));
        $arr = array();
