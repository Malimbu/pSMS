...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->select2Row($model, 'member_id', array(
		'asDropDownList' => true, 
		'data' => Member::model()->getOptions(),
		'val'=>'Dosen',
		'multiple' => 'multiple',			
		'options' => array(
			'width' => '80%',
		...
		<div class="control-group">
		 ...
		 <?php echo $form->textAreaRow($model, 'message', array('class'=>'span8', 'rows'=>5,'maxlength'=>459,'id'=>'message')); ?>
